...
#need to add an extra term with (fv*(1-Q)) and create and endec_cow_cov parameter.
#can keep it in this model so have the option of both human and cattle endectocide on at the same time.
