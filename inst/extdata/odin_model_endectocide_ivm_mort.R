#modelling ivm-mort differently here: ivm mort acts on the background mort rate, not rate with int
#so LLINs delay refeeding and uptake but ivm only kills mosquitoes not killed by the net
...
dim(mu_vi) = eff_len
mu_vi[1:eff_len] = haz[i]*mu0 #changed this from haz[i]*mu
