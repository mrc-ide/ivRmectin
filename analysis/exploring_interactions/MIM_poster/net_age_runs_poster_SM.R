...
#  filter(itn_cov %in% c(0.2,0.8) & d_ITN0 %in% c(res[1], res[5]) & init_EIR == "25")
...
saveRDS(antag, file = "analysis/exploring_interactions/MIM_poster/antag_SM.rds")
saveRDS(add, file = "analysis/exploring_interactions/MIM_poster/add_SM.rds")
