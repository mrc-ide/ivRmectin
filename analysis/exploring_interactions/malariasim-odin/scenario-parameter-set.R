...
bites_Bed_vec <- c(0.38, 0.99) #from ESS review
#Q0_vec <- 0.92
Q0_vec <- c(0.21, 0.94) #override to explore extremes
res <- c(0.5, 0.9) #could change this to 0.1 and 0.9 - more extreme --> more likely to detect a difference
init_EIR_vec <- c(30, 100)
#itn_cov_vec <- 0.9
itn_cov_vec <- c(0.1, 0.9) # two extremes. Could do 0.1 to 0.9 #lower limit for MAP in Africa is 0.12 and Bijagos Bubaque usage is 0.86 to taking 0.9 upper limit.
ivm_cov_vec <- c(0.6, 0.8) # two extremes. See ranges in trial. (lower for trial is 60.4%, upper 78.7)
