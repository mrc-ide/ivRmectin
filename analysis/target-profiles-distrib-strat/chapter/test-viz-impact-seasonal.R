...
df_distr_all <- readRDS("analysis/target-profiles-distrib-strat/chapter/output/df_distr_HR_3m_HS_test_Sen.rds")
...
mv_plot <- ggplot(df_distr, aes(x = (t - start)/365, y = mv, col = as.factor(model_type))) +
  ...
  geom_segment(aes(x = 0, y = max_mv+10, xend = 0, yend = max_mv), arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+ #first MDA
  geom_segment(aes(x = second_mda/365, y = max_mv+10, xend = second_mda/365, yend = max_mv), arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+ #second MDA
  geom_segment(aes(x = third_mda/365, y = max_mv+10, xend = third_mda/365, yend = max_mv), arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+ #third MDA
  geom_segment(aes(x = plot_matamal/365, y = max_mv+10, xend = plot_matamal/365, yend = max_mv),
...
eir_plot <- ggplot(df_distr, aes(x = (t - start)/365, y = EIRout, col = as.factor(model_type)))+
  ...
  guides(col = "none")+
  coord_cartesian(xlim = c(-0.25,1))+
  ylab("Average number of infectious bites per person per day \n (daily EIR)")+
  xlab("Years since intervention started") +
  geom_segment(aes(x = 0, y = max_eir+0.05, xend = 0, yend =max_eir), arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+
  geom_segment(aes(x = second_mda/365, y = max_eir+0.05, xend = second_mda/365, yend =max_eir), arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+
  geom_segment(aes(x = third_mda/365, y = max_eir+0.05, xend = third_mda/365, yend =max_eir), arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+
  geom_segment(aes(x = plot_matamal/365, y = max_eir+0.05, xend = plot_matamal/365, yend = max_eir),
               arrow = arrow(length = unit(0.3, "cm")),
               col = "blue", size = 1.1)+
...
prev_plot <- ggplot(df_distr, aes(x = (t - start)/365, y = slide_prev0to5*100, col = as.factor(model_type)))+
  ...
  geom_segment(aes(x = 0, y = max_prev+5, xend = 0, yend =max_prev), arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+
  geom_segment(aes(x = second_mda/365, y = max_prev+5, xend = second_mda/365, yend =max_prev), arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+
  geom_segment(aes(x = third_mda/365, y = max_prev+5, xend = third_mda/365, yend =max_prev), arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+
  geom_segment(aes(x = plot_matamal/365, y = max_prev+5, xend = plot_matamal/365, yend = max_prev),
               arrow = arrow(length = unit(0.3, "cm")),
               col = "blue", size = 1.1)+
...
inc_plot <- ggplot(df_distr, aes(x = (t - start)/365, y = clin_inc0to5*1000, col = as.factor(model_type)))+
  ...
  coord_cartesian(xlim = c(-0.25,1))+
  xlab("Years since intervention started")+
  geom_segment(aes(x = 0, y = max_inc+1, xend = 0, yend =max_inc), arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+
  geom_segment(aes(x = second_mda/365, y = max_inc+1, xend = second_mda/365,
                   yend =max_inc), arrow = arrow(length = unit(0.3, "cm")),
              col = "black", size = 1.1)+
  geom_segment(aes(x = third_mda/365, y = max_inc+1, xend = third_mda/365, yend =max_inc),
               arrow = arrow(length = unit(0.3, "cm")),
               col = "black", size = 1.1)+
  geom_segment(aes(x = plot_matamal/365, y = max_inc+1, xend = plot_matamal/365, yend = max_inc),
               arrow = arrow(length = unit(0.3, "cm")),
               col = "blue", size = 1.1)+
...
ggsave(plot_seasonal, file = "analysis/target-profiles-distrib-strat/chapter/plots/figure_impact_seasonal.svg")
ggsave(plot_seasonal, file = "analysis/target-profiles-distrib-strat/chapter/plots/figure_impact_seasonal.pdf")
