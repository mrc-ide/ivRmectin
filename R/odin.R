...
odin_model_endectocide_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_endectocide_rhs_dde",
      rhs_desolve = "odin_model_endectocide_rhs_desolve",
      initmod_desolve = "odin_model_endectocide_initmod_desolve",
      output_dde = "odin_model_endectocide_output_dde"),
    dll = "ivRmectin",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             ...
             "ft", "gamma1", "gammaD", "gammaL", "haz", "het_wt", "IB0",
             ...
             "ITN_interval", "ITN_IRS_on", "itn_loss", "ivm_cov_par",
             "ivm_max_age", "ivm_min_age", "IVRM_start", "kB", "kC", "kD",
             ...
             "tau1", "tau2", "theta_c", "ttt", "uB", "uCA", "uD", "x_I"),
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_endectocide_rhs_dde", package = "ivRmectin")
        .C("odin_model_endectocide_rhs_desolve", package = "ivRmectin")
        .C("odin_model_endectocide_initmod_desolve", package = "ivRmectin")
        .C("odin_model_endectocide_output_dde", package = "ivRmectin")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_endectocide_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ivRmectin")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_endectocide_metadata", private$ptr,
                    PACKAGE = "ivRmectin")
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("odin_model_endectocide_create", user, PACKAGE = "ivRmectin")
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_endectocide.json", mustWork = TRUE,
                             package = "ivRmectin")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("odin_model_endectocide_set_user", private$ptr, user, PACKAGE = "ivRmectin")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_endectocide_initial_conditions", private$ptr, t, PACKAGE = "ivRmectin")
    },

    rhs = function(t, y) {
      .Call("odin_model_endectocide_rhs_r", private$ptr, t, y, PACKAGE = "ivRmectin")
    },
    ...
    contents = function() {
      .Call("odin_model_endectocide_contents", private$ptr, PACKAGE = "ivRmectin")
    },
...
odin_model_endectocide <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("odin_model_endectocide")
  odin_model_endectocide_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_endectocide) <- "odin_generator"
attr(odin_model_endectocide, "generator") <- odin_model_endectocide_
