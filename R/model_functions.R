...
Run_Model <- function(age,EIR,ft,admin2,time){
  ...
  #odin_model_path <- system.file("extdata/odin_model_parity_GOOD_drugs_newP.R",package="hanojoel")
  odin_model_path <- system.file("extdata/odin_model.R",package="hanojoel")
  gen <- odin::odin(odin_model_path,verbose=FALSE, skip_cache = TRUE) #,build = TRUE)
